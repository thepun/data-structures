...
public final class UnboundedArrayDemultiplexer<T> implements Demultiplexer<T> {
    ...
    public UnboundedArrayDemultiplexer(int bufferSize) {
        if (bufferSize < 1) {
    ...
    private static final class RingBufferConsumer<T> implements QueueHead<T> {
        ...
        private final UnboundedArrayDemultiplexer<T> parent;
        ...
        private RingBufferConsumer(UnboundedArrayDemultiplexer<T> parent) {
            this.parent = parent;

...
public final class RingBufferRouterWithXADD<T> implements Router<T> {
    ...
    public RingBufferRouterWithXADD(int bufferSize) {
        if (bufferSize < 1) {
    ...
    private static final class RingBufferProducer<T> implements QueueTail<T> {
        ...
        private final RingBufferRouterWithXADD<T> parent;
        ...
        private RingBufferProducer(RingBufferRouterWithXADD<T> parent) {
            this.parent = parent;
    ...
    private static final class RingBufferConsumer<T> implements QueueHead<T> {
        ...
        private RingBufferConsumer(RingBufferRouterWithXADD<T> parent) {
            this.parent = parent;
